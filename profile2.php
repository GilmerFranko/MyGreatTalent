											...
											<div class="avatar-box">
												...
												if (isLogged()) {
													...
													if ($userbuscado["permission_send_gift"] == 0){
														echo '<a href="'.$sitio['site'].'profile.php?profile_id=' . $userbuscado['id'] . '&permission_send_gift=1" class="btn btn-success dropdown-item width" ><i class="fa fa-check"></i> Permitir enviar regalos</a><br class="br">';
													}else{
														echo '<a href="'.$sitio['site'].'profile.php?profile_id=' . $userbuscado['id'] . '&permission_send_gift=0" class="btn btn-danger dropdown-item width" ><i class="fa fa-lock"></i> Bloquear enviar regalos</a><br class="br">';
													}
												}
