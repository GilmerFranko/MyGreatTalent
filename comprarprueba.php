...
head();
?>
<script src="https://www.paypal.com/sdk/js?client-id=AeWtdFOl3RnAvVRRnpcmL0nPLf5zTVQzFzElc5otBpP1UpVN2IIutbyJtTI5GNkLGU0gVWBZ2hkcKNqA&enable-funding=venmo&currency=USD" data-sdk-integration-source="button-factory"></script>
<div class="content-wrapper" height="10%">
	<div id="content-container">
		<section class="content-header">
			...
			<h4><i class="fab fa-paypal"></i> Comprar con PayPal (comunícate <a href="https://my-great-talent.com/newchat.php?id=46339">AQUÍ</a> con nosotros si tienes algún inconveniente)</h4>
		</section>
		<?php				
