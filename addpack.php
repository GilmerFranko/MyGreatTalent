  ...
  if (isset($_POST['save'])){
    ...
    if($_FILES["files"]) {
      foreach($_FILES["files"]["name"] as $key => $FILE){
        ...
        if(move_uploaded_file($_FILES["files"]["tmp_name"][$key], "images/packs/" . $filename)){
          $Images[] = $imagen;
        }
      }
    }
    ...
    // GUARDAR PACK
    $insertarcompra = mysqli_query($connect, "INSERT INTO `packsenventa` (player_id, imagens,image_count,video_length, precio, descripcion,hidetochat,linkdedescarga,visible) VALUES
      ('$rowu[id]', '$jsonImages', '$countImages' , '$total_time' , '$precio', '$descripcion','$hidetochat', '$link','$json')");
    // ID DEL PACK
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="row input-group-addon">
                        ...
                        <div class="col-xs-2">
                          <a class="btn btn-primary" data-toggle="modal" data-target="#modalvideo">Video</a>
                        </div>
                        <div class="col-xs-4"></div>
                      </div>

                      <div class="form-group">
                        <label class="col-md-3 control-label" for="inputDefault">Precio mínimo 10 Créditos:</label>
                        <div class="col-md-8">
                          <div class="input-group">
                            <span class="input-group-addon"></span>
...
<div class="modal fade" id="modalvideo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document" style="position:absolute;top:50%;left:50%;transform:translate(-50%, -50%);width:95%;max-width:600px;margin:0;border-radius:5px;overflow:hidden;">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Opcionalmente puedes agregar la duracion del Video<br></h5>

        <h6 class="modal-title" id="exampleModalLabel">Si tu video no llega a durar mas de una hora, puedes dejar la casilla Hora vacia.<br></h6>
...
<div class="modal fade" id="modalimagen" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document" style="position:absolute;top:50%;left:50%;transform:translate(-50%, -50%);width:95%;max-width:600px;margin:0;border-radius:5px;overflow:hidden;">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Opcionalmente puedes agregar la cantidad de imagenes que contena tu pack<br></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="position:absolute;top:0;right:0;padding:16px;">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
